...
SQL-TYPE : because SQL clause could be different types likes DAL, DCL, DDL, DML, DQL, TCL, and the name of some path could be that abbreviation, just replace abbreviation with SQL-TYPE key word
## Integration Test
